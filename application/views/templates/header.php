...
<head>
  ...
  <title><?= $title; ?> - Asset IT Fyfe</title>
      ...
      <div class="main-sidebar sidebar-style-2 py-3">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= $this->uri->segment(1) == 'karyawan' ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('karyawan'); ?>">
              <i class="fas fa-users"></i> <span>Karyawan</span></a>
            </li>
            ...
            <li class="<?= $this->uri->segment(1) == 'serah-terima' ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('serah-terima'); ?>">
              <i class="fas fa-hands-helping"></i> <span>Serah Terima</span></a>
            </li>
